        ...
        <div className="container mx-auto px-8 py-12">
                ...
                <div className="col-span-1 md:col-span-1">
                    <a href="/#">
                        <div className="flex items-center mb-2">
                            ...
                            <h3 className="text-xl font-bold">YumeCraft</h3>
                        </div>
                    </a>
            ...
            <div className="border-t border-gray-400/50 pt-6 flex flex-col md:flex-row justify-between items-center text-sm text-gray-600">
                ...
                <div className="flex space-x-4 mt-4 md:mt-0">
                    <a href="https://www.linkedin.com/in/likhith-raj005/" target="_blank" className="hover:text-gray-900"><Linkedin size={18} /></a>
                    <a href="https://www.instagram.com" target="_blank" className="hover:text-gray-900"><Instagram size={18} /></a>
                    <a href="https://likhithraj.netlify.app/" target="_blank" className="hover:text-gray-900"><Dribbble size={18} /></a>
                </div>
            </div>
        </div>
    </footer>
